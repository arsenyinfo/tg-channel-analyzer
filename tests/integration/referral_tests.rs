...
async fn test_progressive_milestone_rewards() {
    ...
    let (referrer, _) = TestScenario::create_referrer_with_unpaid_referrals(&user_manager, 500, 25)
        .await
        .expect("Failed to create referrer with 25 referrals");
